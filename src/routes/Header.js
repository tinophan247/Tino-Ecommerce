...
function Header() {
  return (
    <div className='w-full'>
      ...
      <div className='bg-[#D2ECED] h-56 flex justify-center '>
        <div className='w-1600 items-start justify-between flex'>
        <img className='h-56' src='./images/logo.png' alt='not-found' />
        

          
            <div className='flex mt-20 ml-16'>
              <input className='w-700 h-14'></input>
              <button className=' bg-blue-300 h-14 w-14 hover:text-blue-900 justify-center'>
                <SearchIcon />
              </button>
